...
<p>
  <h3><?php echo __('See <a href="http://raynfall.com/btbe-user-manual/" target="_blank">the Showcase User Manual</a> for a complete list of how to use the shortcodes.', 'author-showcase'); ?></h3>
